...
public class AutonShoot1 extends CommandBase {
	...
	public AutonShoot1(Indexer indexer, Shooter shooter, Turret turret, double shootDelay, double RPM, double hoodAngle, double turretAngle) {
