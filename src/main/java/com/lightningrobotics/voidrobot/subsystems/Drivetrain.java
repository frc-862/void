...
public class Drivetrain extends DifferentialDrivetrain {
    ...
    private static final MotorController[] LEFT_MOTORS = new MotorController[]{
        new WPI_TalonFX(Constants.LEFT_MOTOR_1),
        new WPI_TalonFX(Constants.LEFT_MOTOR_2),
        new WPI_TalonFX(Constants.LEFT_MOTOR_3)
    };

    private static final MotorController[] RIGHT_MOTORS = new MotorController[]{
        new WPI_TalonFX(Constants.RIGHT_MOTOR_1),
        new WPI_TalonFX(Constants.RIGHT_MOTOR_2),
        new WPI_TalonFX(Constants.RIGHT_MOTOR_3)
    };
